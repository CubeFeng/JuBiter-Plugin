...
export 'Jub_Ethereum.pbenum.dart';
...
class ContextCfgETH extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ContextCfgETH', package: const $pb.PackageName('JUB.Proto.Ethereum'), createEmptyInstance: create)
    ..aOS(1, 'mainPath')
    ..a<$core.int>(2, 'chainID', $pb.PbFieldType.OU3, protoName: 'chainID')
...
class TransactionETH extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TransactionETH', package: const $pb.PackageName('JUB.Proto.Ethereum'), createEmptyInstance: create)
    ..aOM<$0.Bip32Path>(1, 'path', subBuilder: $0.Bip32Path.create)
    ..a<$core.int>(2, 'nonce', $pb.PbFieldType.OU3)
    ..a<$core.int>(3, 'gasLimit', $pb.PbFieldType.OU3, protoName: 'gasLimit')
    ..aOS(4, 'gasPriceInWei', protoName: 'gasPriceInWei')
    ..aOS(5, 'to')
    ..aOS(6, 'valueInWei', protoName: 'valueInWei')
    ..aOS(7, 'input')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $0.Bip32Path get path => $_getN(0);
  @$pb.TagNumber(1)
  set path($0.Bip32Path v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPath() => $_has(0);
  @$pb.TagNumber(1)
  void clearPath() => clearField(1);
  @$pb.TagNumber(1)
  $0.Bip32Path ensurePath() => $_ensure(0);

...
class InputBTC extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InputBTC', package: const $pb.PackageName('JUB.Proto.Bitcoin'), createEmptyInstance: create)
    ..aOS(1, 'preHash', protoName: 'preHash')
    ..a<$core.int>(2, 'preIndex', $pb.PbFieldType.OU3, protoName: 'preIndex')
    ..a<$fixnum.Int64>(3, 'amount', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$0.Bip32Path>(4, 'path', subBuilder: $0.Bip32Path.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $0.Bip32Path get path => $_getN(3);
  @$pb.TagNumber(4)
  set path($0.Bip32Path v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPath() => $_has(3);
  @$pb.TagNumber(4)
  void clearPath() => clearField(4);
  @$pb.TagNumber(4)
  $0.Bip32Path ensurePath() => $_ensure(3);
}
...
class StandardOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StandardOutput', package: const $pb.PackageName('JUB.Proto.Bitcoin'), createEmptyInstance: create)
    ...
    ..aOB(3, 'changeAddress', protoName: 'changeAddress')
    ..aOM<$0.Bip32Path>(4, 'path', subBuilder: $0.Bip32Path.create)
    ..hasRequiredFields = false
  ;
...
class OutputBTC extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, OutputBTC_Output> _OutputBTC_OutputByTag = {
    2 : OutputBTC_Output.standardOputput,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OutputBTC', package: const $pb.PackageName('JUB.Proto.Bitcoin'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..e<ENUM_SCRIPT_TYPE_BTC>(1, 'type', $pb.PbFieldType.OE, defaultOrMaker: ENUM_SCRIPT_TYPE_BTC.STANDARD, valueOf: ENUM_SCRIPT_TYPE_BTC.valueOf, enumValues: ENUM_SCRIPT_TYPE_BTC.values)
    ..aOM<StandardOutput>(2, 'standardOputput', protoName: 'standardOputput', subBuilder: StandardOutput.create)
    ..aOM<Return0Output>(3, 'return0Output', protoName: 'return0Output', subBuilder: Return0Output.create)
    ..aOM<QRC20Output>(4, 'qrc20Output', protoName: 'qrc20Output', subBuilder: QRC20Output.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  StandardOutput get standardOputput => $_getN(1);
  @$pb.TagNumber(2)
  set standardOputput(StandardOutput v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStandardOputput() => $_has(1);
  @$pb.TagNumber(2)
  void clearStandardOputput() => clearField(2);
  @$pb.TagNumber(2)
  StandardOutput ensureStandardOputput() => $_ensure(1);

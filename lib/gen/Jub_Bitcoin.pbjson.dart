...
const InputBTC$json = const {
  '1': 'InputBTC',
  '2': const [
    const {'1': 'preHash', '3': 1, '4': 1, '5': 9, '10': 'preHash'},
    const {'1': 'preIndex', '3': 2, '4': 1, '5': 13, '10': 'preIndex'},
    const {'1': 'amount', '3': 3, '4': 1, '5': 4, '10': 'amount'},
    const {'1': 'path', '3': 4, '4': 1, '5': 11, '6': '.JUB.Proto.Common.Bip32Path', '10': 'path'},
  ],
};
...
const StandardOutput$json = const {
  ...
  '2': const [
    ...
    const {'1': 'changeAddress', '3': 3, '4': 1, '5': 8, '10': 'changeAddress'},
    const {'1': 'path', '3': 4, '4': 1, '5': 11, '6': '.JUB.Proto.Common.Bip32Path', '10': 'path'},
  ],
};
...
const OutputBTC$json = const {
  ...
  '2': const [
    ...
    const {'1': 'standardOputput', '3': 2, '4': 1, '5': 11, '6': '.JUB.Proto.Bitcoin.StandardOutput', '9': 0, '10': 'standardOputput'},
    const {'1': 'return0Output', '3': 3, '4': 1, '5': 11, '6': '.JUB.Proto.Bitcoin.Return0Output', '9': 0, '10': 'return0Output'},
    const {'1': 'qrc20Output', '3': 4, '4': 1, '5': 11, '6': '.JUB.Proto.Bitcoin.QRC20Output', '9': 0, '10': 'qrc20Output'},
  ],
  '8': const [
    const {'1': 'output'},
  ],
